...
# Unit tests for DockerHub::Invite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHub::Invite do
  #let(:instance) { DockerHub::Invite.new }

  describe 'test an instance of Invite' do
    it 'should create an instance of Invite' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(DockerHub::Invite)
    end
  end
  ...
  describe 'test attribute "inviter_username"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
