...
# Unit tests for DockerHub::TeamRepo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DockerHub::TeamRepo do
  let(:instance) { DockerHub::TeamRepo.new }

  describe 'test an instance of TeamRepo' do
    it 'should create an instance of TeamRepo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(DockerHub::TeamRepo)
    end
  end
